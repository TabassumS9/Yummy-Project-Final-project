                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form action="../controller/register.php" method="$_POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input name="repeatPassword" type="password" class="form-control form-control-user"
                                            ...
                                            <span class="text-danger"><?= isset($_SESSION['register_error']['repeatPassword_error']) ? $_SESSION['register_error']['repeatPassword_error'] : ''?></span>    
                                    </div>
                                </div>
